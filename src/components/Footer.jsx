  ...
  return (
    <footer className='font-Mandrope w-full max-w-[1320px] mx-auto bg-gradient-to-br from-first to-second py-5 rounded-xl'>
      ...
      <div className="flex flex-col md:flex-row  justify-start md:justify-between items-center">
          <Link to="/" className=' border-gray-500/10 border rounded-lg text-4xl text-yellow-600 bg-gradient-to-br from-first to-second  py-3 px-5 inline-flex font-Mandrope'>M</Link>
          <nav>
        ...
        <div className="flex justify-between text-white/10 pt-3">
